...
const {createProblem,updateProblem,deleteProblem,getProblem,getAllProblems,getAllProblemsSolvedByUser,solutionsOfProblem} = require("../controllers/problemController");
...
problemRouter.get("/solutionsOfProblem/:id",userVerification,solutionsOfProblem);

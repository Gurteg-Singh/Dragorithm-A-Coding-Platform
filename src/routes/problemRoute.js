...
const {createProblem,updateProblem,deleteProblem,getProblem,getAllProblems,getAllProblemsSolvedByUser,soltionsOfProblem} = require("../controllers/problemController");
...
problemRouter.get("/soltionsOfProblem/:id",userVerification,soltionsOfProblem);
